        ...
        <div class="row">
          <div class="col-md-12">
            <div class="tile">
              ...
              <form method="post" action="{{route('course.update',$student->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="description" class="form-control " value="{{$student->description}}">
                ...
                <div class="form-group">
                    <label>est_salary:</label>
                    <input type="text" name="est_salary" class="form-control " value="{{$student->est_salary}}">
