...
<div class="card col-md-6 ml-5" style="width: 40rem;">
    <img class="card-img-top" src="{{ asset($teacher->photo) }}" alt="Card image cap">

        <ul class="list-group card-body">
            <li class="list-group-item h4 bg-info">{{ $teacher->name }}</li>
            <li class="list-group-item" h5>Course URL : {{ $teacher->description }}</li>
